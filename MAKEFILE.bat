...
copy /y /v %~dp0\massachusetts_town_names.grf C:\Users\train\Documents\OpenTTD\newgrf\
copy /y /v %~dp0\colorado_town_names.grf C:\Users\train\Documents\OpenTTD\newgrf\
copy /y /v %~dp0\north_carolina_town_names.grf C:\Users\train\Documents\OpenTTD\newgrf\
copy /y /v %~dp0\pennsylvania_town_names.grf C:\Users\train\Documents\OpenTTD\newgrf\
